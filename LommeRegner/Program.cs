...
Console.WriteLine($"The sum of 4 + 4 is {calculator.Add(4)}");
Console.WriteLine("If the ansawer was 8 then the test works");


Console.WriteLine("Testing Subtract class");

Console.WriteLine($"The sum of 8 - 4 is {calculator.Subtract(4)}");
...
Console.WriteLine($"The sum of 8 * 4 is {calculator.Multiply(4)}");
...
Console.WriteLine($"The sum of 8 ^ 4 is {calculator.Power(4)}");
